...
Rscript 09_Clinical_features_subclusters.R --input Discovery/02_Missing_Inspection_subclusters/norm_imp_MinProb.rds --cluster Discovery/08_Clustering_als/cluster_assignments_2.csv --output Discovery/09_Clinical_features_subclusters --vars "age,age_at_onset,Nfl,pNFh" --merge TRUE --row 1
Rscript 09_Clinical_features_subclusters.R --input Discovery/02_Missing_Inspection_subclusters/norm_imp_MinProb.rds --cluster Discovery/08_Clustering_als/cluster_assignments_2.csv --output Discovery/09_Clinical_features_subclusters --vars "progression_group,sex,condition" --merge TRUE --row 1

Rscript 09_Clinical_features_subclusters.R --input Validation/02_Missing_Inspection_subclusters/norm_imp_MinProb.rds --cluster Validation/08_Clustering_als/cluster_assignments_2.csv --output Validation/09_Clinical_features_subclusters --vars "age,age_at_onset,Nfl" --merge TRUE --row 1
Rscript 09_Clinical_features_subclusters.R --input Validation/02_Missing_Inspection_subclusters/norm_imp_MinProb.rds --cluster Validation/08_Clustering_als/cluster_assignments_2.csv --output Validation/09_Clinical_features_subclusters --vars "progression_group,sex,condition" --merge TRUE --row 1


###########
Rscript 20_External_protein_expression.R -i External/norm_imp_MinProb_als.rds --features 15_ML_multi_models_500_04_noAge_3sd/selected_features.txt -o 20_External_protein_expression