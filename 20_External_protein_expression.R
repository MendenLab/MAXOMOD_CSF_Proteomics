...
option_list <- list(
  ...
  make_option(c("-f", "--features"), 
              type="character", 
              default="15_ML_multi_models_500_04_noAge_3sd/selected_features.txt",
              help="Path to selected features file [default: %default]"),
  make_option(c("-o", "--output"), 
              type="character", 
              default="20_External_protein_expression/",
...
output_file = file.path(output_dir, "boxplot_external.svg")
